...
which_in_box <- function(ord0, ord1, lower, upper) {
    .Call(`_rvinecopulib_which_in_box`, ord0, ord1, lower, upper)
}
...
find_latent_sample2 <- function(u, b, niter = 5L) {
    .Call(`_rvinecopulib_find_latent_sample2`, u, b, niter)
}
