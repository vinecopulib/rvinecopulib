...
vinecop_scores_cpp <- function(u, svinecop_r, step_wise = TRUE, step_size = 1e-3, num_threads = 1L) {
    .Call(`_rvinecopulib_vinecop_scores_cpp`, u, svinecop_r, step_wise, step_size, num_threads)
}

vinecop_hessian_avg_cpp <- function(u, svinecop_r, step_wise = TRUE, step_size = 1e-3, num_threads = 1L) {
    .Call(`_rvinecopulib_vinecop_hessian_avg_cpp`, u, svinecop_r, step_wise, step_size, num_threads)
}

vinecop_hessian_cpp <- function(u, svinecop_r, step_wise = TRUE, step_size = 1e-3, num_threads = 1L) {
    .Call(`_rvinecopulib_vinecop_hessian_cpp`, u, svinecop_r, step_wise, step_size, num_threads)
}
