...
specifies a family, rotation, parameters, and variable types.
...
converts family parameters to Kendall’s tau, and
[`ktau_to_par()`](https://vinecopulib.github.io/rvinecopulib/reference/par_to_ktau.md)
provides the inverse for families where tau determines all parameters.
Model objects expose Kendall’s tau through
...
reports the four corner tail-dependence coefficients. This is especially
useful for rotated and asymmetric families, where a single lower/upper
pair is not enough to describe the model.

## Fit and select from data

[`bicop()`](https://vinecopulib.github.io/rvinecopulib/reference/bicop.md)
expects two approximately uniform columns. It fits every requested
