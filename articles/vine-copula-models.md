...
structures are available through
...
for the complete validity and proximity conditions.
...
With no structure supplied,
[`vinecop()`](https://vinecopulib.github.io/rvinecopulib/reference/vinecop.md)
selects trees sequentially using the Dissmann algorithm and fits a pair
copula on every selected edge.
...
[`vinecop()`](https://vinecopulib.github.io/rvinecopulib/reference/vinecop.md)
to select the remaining trees up to `trunc_lvl`.
...
For a manually constructed distribution, use
[`vinecop()`](https://vinecopulib.github.io/rvinecopulib/reference/vinecop.md)
to select from data or construct a new
[`vinecop_dist()`](https://vinecopulib.github.io/rvinecopulib/reference/vinecop_dist.md)
after changing its components.
...
- [Discrete, mixed, and zero-inflated
  ...
  explains the copula-scale representation required when some variables
  have atoms.
