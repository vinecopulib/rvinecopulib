...
|----|----|----|
| Two uniform variables | [`bicop()`](https://vinecopulib.github.io/rvinecopulib/reference/bicop.md) | One bivariate copula |
| Uniform pseudo-observations | [`vinecop()`](https://vinecopulib.github.io/rvinecopulib/reference/vinecop.md) | Dependence only |
| Observations on their original scale | [`vine()`](https://vinecopulib.github.io/rvinecopulib/reference/vine.md) | Margins and dependence |

### A bivariate copula

[`bicop()`](https://vinecopulib.github.io/rvinecopulib/reference/bicop.md)
fits and selects a copula model for two uniform variables. Fixed models
can be created with
...
converts continuous observations to approximately uniform scores.
[`vinecop()`](https://vinecopulib.github.io/rvinecopulib/reference/vinecop.md)
then selects the vine structure, pair-copula families, and parameters.
...
fits one marginal distribution per variable and a vine copula to their
probability integral transforms. The default margins are nonparametric;
