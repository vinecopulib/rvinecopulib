...
- complete multivariate distributions with nonparametric, parametric, or
  custom margins;
...
The framework is exposed at three levels.
[`vine()`](https://vinecopulib.github.io/rvinecopulib/reference/vine.md)
models observations on their original scale by fitting the marginal
distributions and dependence model together.
[`vinecop()`](https://vinecopulib.github.io/rvinecopulib/reference/vinecop.md)
models uniform pseudo-observations when only the dependence model is
required.
[`bicop()`](https://vinecopulib.github.io/rvinecopulib/reference/bicop.md)
provides the corresponding two-variable workflow.
...
Start with
[`vignette("getting-started")`](https://vinecopulib.github.io/rvinecopulib/articles/getting-started.md).
Dedicated articles cover bivariate copulas, vine structures and
selection, marginal models, discrete data, conditional simulation, and
likelihood derivatives. The [package
website](https://vinecopulib.github.io/rvinecopulib/) contains the
