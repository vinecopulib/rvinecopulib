...
// rvine_matrix_get_order
Eigen::Matrix<size_t, Eigen::Dynamic, Eigen::Dynamic> rvine_matrix_get_order(Eigen::Matrix<size_t, Eigen::Dynamic, Eigen::Dynamic> matrix);
RcppExport SEXP rvinecopulib_rvine_matrix_get_order(SEXP matrixSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Eigen::Matrix<size_t, Eigen::Dynamic, Eigen::Dynamic> >::type matrix(matrixSEXP);
    rcpp_result_gen = Rcpp::wrap(rvine_matrix_get_order(matrix));
    return rcpp_result_gen;
END_RCPP
}
// vinecop_check_cpp
...
RcppExport SEXP rvinecopulib_vinecop_loglik_cpp(SEXP uSEXP, SEXP vinecop_rSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Eigen::MatrixXd& >::type u(uSEXP);
...
RcppExport SEXP rvinecopulib_vinecop_aic_cpp(SEXP uSEXP, SEXP vinecop_rSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Eigen::MatrixXd& >::type u(uSEXP);
...
RcppExport SEXP rvinecopulib_vinecop_bic_cpp(SEXP uSEXP, SEXP vinecop_rSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Eigen::MatrixXd& >::type u(uSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"rvinecopulib_rvine_matrix_get_order", (DL_FUNC) &rvinecopulib_rvine_matrix_get_order, 1},
    ...
    {"rvinecopulib_vinecop_aic_cpp", (DL_FUNC) &rvinecopulib_vinecop_aic_cpp, 2},
    {"rvinecopulib_vinecop_bic_cpp", (DL_FUNC) &rvinecopulib_vinecop_bic_cpp, 2},
