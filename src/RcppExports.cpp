...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< size_t >::type num_threads(num_threadsSEXP);
    Rcpp::traits::input_parameter< std::vector<std::string> >::type var_types(var_typesSEXP);
    rcpp_result_gen = Rcpp::wrap(vinecop_select_cpp(data, is_structure_provided, structure, family_set, par_method, nonpar_method, mult, truncation_level, tree_criterion, threshold, selection_criterion, weights, psi0, select_truncation_level, select_threshold, preselect_families, show_trace, num_threads, var_types));
    return rcpp_result_gen;
END_RCPP
}
